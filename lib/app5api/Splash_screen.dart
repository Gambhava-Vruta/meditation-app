...
// import 'package:flutter_project/app5api/buttomnavigation.dart'; // Import your main screen after login.
//
// class SplashScreen extends StatefulWidget {
//   @override
//   _SplashScreenState createState() => _SplashScreenState();
...
import 'dart:async';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:flutter_project/app5api/buttomnavigation.dart';

import 'onboardScreen.dart'; // Import your main screen after login.
...
class _SplashScreenState extends State<SplashScreen> {
  ...
  Future<void> _navigateBasedOnLoginStatus() async {
    ...
    if (isLoggedIn) {
      ...
      // Otherwise, navigate to the OnboardingScreen
      Navigator.of(context).pushReplacement(
